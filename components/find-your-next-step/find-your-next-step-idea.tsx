...
export function FindYourNextStepIdea({ journey, locale }: { journey: NextStepJourney; locale: Locale }) {
        ...
        <header className="grid gap-10 border-b border-white/15 py-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-end lg:py-24">
          <div>
            <div className="flex flex-wrap items-center gap-4">
              <p className="font-mono text-xs font-black uppercase tracking-[0.28em] text-[var(--journey-accent)]">Find Your Next Step / {shell.path} {journey.number}</p>
