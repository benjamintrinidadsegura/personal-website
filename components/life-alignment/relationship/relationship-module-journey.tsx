...
import { RelationshipResultQuote } from "@/components/quotes/result-quotes";
...
export function RelationshipModuleJourney({ module, authenticated }: { module: RelationshipModuleDefinition; authenticated: boolean }) {
  ...
  if (mode === "result" && soloResult) return <><SoloResultView module={module} result={soloResult}/><div className="section-lines px-5 pb-24 sm:px-8"><div className="mx-auto max-w-5xl"><RelationshipResultQuote moduleId={module.id} result={soloResult}/></div></div></>;
