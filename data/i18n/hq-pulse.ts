...
const copy: Record<Locale, HqPulseCopy> = {
  de: {
    ...
    humanMarker: "Menschlicher Kontext", humanTitle: "Worauf die Aufmerksamkeit gerade liegt.", humanDescription: "Bedeutung, Fokus und Einladung bleiben bewusst menschlich geschrieben.", rightNow: "Gerade jetzt", onMyMind: "In meinen Gedanken", next: "Als Nächstes", participationMarker: "Teil der Reise", openLoops: "Mach mit", openLoopsDescription: "Ideen, Feedback, Geschichten oder Lust, etwas gemeinsam zu bauen? Hier kannst du Teil davon werden.", noOpenLoops: "Zurzeit sind hier keine aktiven öffentlichen Einladungen eingetragen.",
  ...
  en: {
    ...
    humanMarker: "Human context", humanTitle: "Where attention is right now.", humanDescription: "Meaning, focus and invitations remain deliberately human-authored.", rightNow: "Right now", onMyMind: "On my mind", next: "Next", participationMarker: "Be part of the journey", openLoops: "Join in", openLoopsDescription: "Ideas, feedback, stories, or want to build something together? This is where you can become part of it.", noOpenLoops: "There are currently no active public invitations listed here.",
  ...
  tr: {
    ...
    humanMarker: "İnsan bağlamı", humanTitle: "Dikkatin şu anda olduğu yer.", humanDescription: "Anlam, odak ve davetler bilinçli olarak insan tarafından yazılır.", rightNow: "Şu anda", onMyMind: "Aklımda", next: "Sırada", participationMarker: "Yolculuğun parçası ol", openLoops: "Katıl", openLoopsDescription: "Bir fikrin, geri bildirimin, hikâyen ya da birlikte bir şeyler inşa etme isteğin mi var? Buradan yolculuğa katılabilirsin.", noOpenLoops: "Şu anda burada etkin bir kamusal davet yok.",
  ...
  pl: {
    ...
    humanMarker: "Ludzki kontekst", humanTitle: "Na czym skupia się teraz uwaga.", humanDescription: "Znaczenie, kierunek i zaproszenia pozostają świadomie pisane przez człowieka.", rightNow: "W tej chwili", onMyMind: "O czym myślę", next: "Dalej", participationMarker: "Dołącz do tej drogi", openLoops: "Dołącz", openLoopsDescription: "Masz pomysł, opinię, historię albo ochotę zbudować coś razem? Tutaj możesz dołączyć.", noOpenLoops: "Obecnie nie ma tu aktywnych publicznych zaproszeń.",
  ...
  el: {
    ...
    humanMarker: "Ανθρώπινο πλαίσιο", humanTitle: "Πού βρίσκεται τώρα η προσοχή.", humanDescription: "Το νόημα, η εστίαση και οι προσκλήσεις παραμένουν συνειδητά ανθρώπινα.", rightNow: "Αυτή τη στιγμή", onMyMind: "Στο μυαλό μου", next: "Επόμενο", participationMarker: "Γίνε μέρος της διαδρομής", openLoops: "Πάρε μέρος", openLoopsDescription: "Έχεις μια ιδέα, σχόλιο, ιστορία ή διάθεση να χτίσουμε κάτι μαζί; Εδώ μπορείς να γίνεις μέρος της διαδρομής.", noOpenLoops: "Αυτή τη στιγμή δεν υπάρχουν ενεργές δημόσιες προσκλήσεις εδώ.",
  ...
  ru: {
    ...
    humanMarker: "Человеческий контекст", humanTitle: "На чём сейчас сосредоточено внимание.", humanDescription: "Смысл, фокус и приглашения остаются осознанно написанными человеком.", rightNow: "Прямо сейчас", onMyMind: "О чём я думаю", next: "Дальше", participationMarker: "Станьте частью пути", openLoops: "Присоединяйтесь", openLoopsDescription: "Есть идея, отзыв, история или желание создать что-то вместе? Здесь можно стать частью этого пути.", noOpenLoops: "Сейчас здесь нет активных публичных приглашений.",
