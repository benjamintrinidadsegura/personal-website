...
const es: GlobalDictionary = {
  ...
  nav: { home: "Inicio", about: "Sobre mí", projects: "Proyectos", allProjects: "Todos los proyectos", insights: "Perspectivas", pulse: "Pulse", writing: "Writing", people: "Personas / Entrevistas", worldMap: "Mapa mundial", tools: "Herramientas", partners: "Colaboraciones", contact: "Contacto", feedback: "Opiniones" },
...
const tr: GlobalDictionary = {
  ...
  nav: { home: "Ana sayfa", about: "Hakkımda", projects: "Projeler", allProjects: "Tüm projeler", insights: "İçgörüler", pulse: "Pulse", writing: "Yazılar", people: "İnsanlar / Röportajlar", worldMap: "Dünya Haritası", tools: "Araçlar", partners: "İş ortakları", contact: "İletişim", feedback: "Geri bildirim" },
...
const pl: GlobalDictionary = {
  ...
  nav: { home: "Strona główna", about: "O mnie", projects: "Projekty", allProjects: "Wszystkie projekty", insights: "Perspektywy", pulse: "Pulse", writing: "Teksty", people: "Ludzie / Wywiady", worldMap: "Mapa świata", tools: "Narzędzia", partners: "Partnerzy", contact: "Kontakt", feedback: "Opinia" },
...
const el: GlobalDictionary = {
  ...
  nav: { home: "Αρχική", about: "Σχετικά", projects: "Έργα", allProjects: "Όλα τα έργα", insights: "Οπτικές", pulse: "Pulse", writing: "Κείμενα", people: "Άνθρωποι / Συνεντεύξεις", worldMap: "Παγκόσμιος χάρτης", tools: "Εργαλεία", partners: "Συνεργασίες", contact: "Επικοινωνία", feedback: "Σχόλιο" },
...
const ru: GlobalDictionary = {
  ...
  nav: { home: "Главная", about: "Обо мне", projects: "Проекты", allProjects: "Все проекты", insights: "Перспективы", pulse: "Pulse", writing: "Тексты", people: "Люди / Интервью", worldMap: "Карта мира", tools: "Инструменты", partners: "Партнёры", contact: "Контакты", feedback: "Отзыв" },
