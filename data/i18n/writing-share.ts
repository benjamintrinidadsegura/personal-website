...
export const writingShareDictionaries = {
  de: {
    trigger: "Diesen Gedanken teilen", articleTrigger: "Diese Geschichte teilen", dialogTitle: "Share Card erstellen", selectedArticle: "Ausgewählte Geschichte", selectedThought: "Ausgewählter Gedanke", style: "Kartenstil", styles: { editorial: "Editorial", socialPost: "Social Post" }, format: "Format",
    ...
    sourceLabel: "Writing", fromArticle: "Aus:", readingTime: "{minutes} Min. Lesezeit", moreContext: "Mehr Kontext", keyThought: "Kerngedanke", section: "Abschnitt",
  },
  en: {
    trigger: "Share this thought", articleTrigger: "Share this story", dialogTitle: "Create share card", selectedArticle: "Selected story", selectedThought: "Selected thought", style: "Card style", styles: { editorial: "Editorial", socialPost: "Social Post" }, format: "Format",
    ...
    sourceLabel: "Writing", fromArticle: "From:", readingTime: "{minutes} min read", moreContext: "More context", keyThought: "Key thought", section: "Section",
  },
  es: {
    trigger: "Compartir esta idea", articleTrigger: "Compartir esta historia", dialogTitle: "Crear tarjeta para compartir", selectedArticle: "Historia seleccionada", selectedThought: "Idea seleccionada", style: "Estilo de tarjeta", styles: { editorial: "Editorial", socialPost: "Publicación social" }, format: "Formato",
    ...
    sourceLabel: "Writing", fromArticle: "De:", readingTime: "{minutes} min de lectura", moreContext: "Más contexto", keyThought: "Idea clave", section: "Sección",
  },
  tr: {
    trigger: "Bu düşünceyi paylaş", articleTrigger: "Bu hikâyeyi paylaş", dialogTitle: "Paylaşım kartı oluştur", selectedArticle: "Seçilen hikâye", selectedThought: "Seçilen düşünce", style: "Kart stili", styles: { editorial: "Editoryal", socialPost: "Sosyal gönderi" }, format: "Biçim",
    ...
    sourceLabel: "Writing", fromArticle: "Kaynak:", readingTime: "{minutes} dk okuma", moreContext: "Daha fazla bağlam", keyThought: "Ana düşünce", section: "Bölüm",
  },
  pl: {
    trigger: "Udostępnij tę myśl", articleTrigger: "Udostępnij tę historię", dialogTitle: "Utwórz kartę do udostępnienia", selectedArticle: "Wybrana historia", selectedThought: "Wybrana myśl", style: "Styl karty", styles: { editorial: "Redakcyjny", socialPost: "Post społecznościowy" }, format: "Format",
    ...
    sourceLabel: "Writing", fromArticle: "Z:", readingTime: "{minutes} min czytania", moreContext: "Więcej kontekstu", keyThought: "Kluczowa myśl", section: "Sekcja",
  },
  el: {
    trigger: "Μοιράσου αυτή τη σκέψη", articleTrigger: "Μοιράσου αυτή την ιστορία", dialogTitle: "Δημιουργία κάρτας κοινοποίησης", selectedArticle: "Επιλεγμένη ιστορία", selectedThought: "Επιλεγμένη σκέψη", style: "Στυλ κάρτας", styles: { editorial: "Editorial", socialPost: "Κοινωνική ανάρτηση" }, format: "Μορφή",
    ...
    sourceLabel: "Writing", fromArticle: "Από:", readingTime: "{minutes} λεπτά ανάγνωσης", moreContext: "Περισσότερο πλαίσιο", keyThought: "Βασική σκέψη", section: "Ενότητα",
  },
  ru: {
    trigger: "Поделиться этой мыслью", articleTrigger: "Поделиться этой историей", dialogTitle: "Создать карточку", selectedArticle: "Выбранная история", selectedThought: "Выбранная мысль", style: "Стиль карточки", styles: { editorial: "Редакционный", socialPost: "Социальный пост" }, format: "Формат",
    ...
    sourceLabel: "Writing", fromArticle: "Из:", readingTime: "{minutes} мин чтения", moreContext: "Больше контекста", keyThought: "Ключевая мысль", section: "Раздел",
  },
