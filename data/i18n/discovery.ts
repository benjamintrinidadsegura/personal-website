...
const extendedStaticCopy: Record<ExtendedLocale, Record<string, Partial<DiscoveryItem>>> = {
  es: {
    ...
    "page-quote": { title: "Cita del día", description: "Una idea diaria seleccionada con más citas y tarjetas BTS para compartir.", category: "Página", tags: ["ideas", "cita", "tarjetas"], keywords: ["cita del día", "idea", "otra cita", "compartir"] },
  ...
  tr: {
    ...
    "page-quote": { title: "Günün Sözü", description: "Daha fazla alıntı ve BTS paylaşım kartlarıyla özenle seçilmiş günlük bir düşünce.", category: "Sayfa", tags: ["içgörüler", "alıntı", "paylaşım kartları"], keywords: ["günün sözü", "düşünce", "başka bir alıntı", "paylaş"] },
  ...
  pl: {
    ...
    "page-quote": { title: "Cytat dnia", description: "Starannie wybrana codzienna myśl z kolejnymi cytatami i kartami BTS do udostępnienia.", category: "Strona", tags: ["wnioski", "cytat", "karty"], keywords: ["cytat dnia", "myśl", "kolejny cytat", "udostępnij"] },
  ...
  el: {
    ...
    "page-quote": { title: "Απόφθεγμα της ημέρας", description: "Μια επιμελημένη καθημερινή σκέψη με περισσότερα αποφθέγματα και κάρτες κοινοποίησης BTS.", category: "Σελίδα", tags: ["ιδέες", "απόφθεγμα", "κάρτες"], keywords: ["απόφθεγμα της ημέρας", "σκέψη", "άλλο απόφθεγμα", "κοινοποίηση"] },
  ...
  ru: {
    ...
    "page-quote": { title: "Цитата дня", description: "Отобранная ежедневная мысль с другими цитатами и карточками BTS для публикации.", category: "Страница", tags: ["идеи", "цитата", "карточки"], keywords: ["цитата дня", "мысль", "другая цитата", "поделиться"] },
