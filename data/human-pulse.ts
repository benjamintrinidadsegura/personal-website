...
export const humanPulseEditorial: Readonly<{
  ...
  next: {
    de: {
      id: "next",
      label: "Als Nächstes",
      text: "Weiter die Dinge bauen, von denen ich mir wünsche, dass es sie gäbe, unterwegs festhalten, was ich lerne, und mehr Menschen begegnen, denen ich sonst nicht begegnet wäre.",
    },
    en: {
      id: "next",
      label: "Next",
    ...
    de: [
      {
        ...
        context: "Ich lerne immer gern Menschen kennen, die ungewöhnliche Dinge bauen, Annahmen hinterfragen und aus Ideen etwas Reales machen wollen.",
        order: 1,
      ...
      },
      {
        ...
        context: "Ich suche Menschen mit interessanten Wegen, Perspektiven und Erfahrungen für Gespräche und Interviews auf bts.online.",
        order: 2,
      ...
      },
      {
        ...
        context: "Siehst du etwas auf bts.online, das besser, ungewöhnlicher, klarer oder nützlicher sein könnte? Ich möchte es wirklich hören.",
        order: 3,
      ...
      },
      {
        ...
        context: "Einige der besten Dinge, die ich gebaut habe, begannen damit, dass mir jemand eine Perspektive, Fähigkeit oder ein Wissen gezeigt hat, das mir bis dahin gefehlt hat.",
        order: 4,
