...
const familySections = [
  section("family-connection", t("Kontakt und Zugehörigkeit", "Connection and belonging", "Conexión y pertenencia", "Bağ ve aidiyet", "Kontakt i przynależność", "Σύνδεση και αίσθηση του ανήκειν", "Связь и принадлежность")),
  section("family-support", t("Fürsorge und Verantwortung", "Care and responsibility", "Cuidado y responsabilidad", "Özen ve sorumluluk", "Troska i odpowiedzialność", "Φροντίδα και ευθύνη", "Забота и ответственность")),
  section("family-boundaries", t("Grenzen und Erwartungen", "Boundaries and expectations", "Límites y expectativas", "Sınırlar ve beklentiler", "Granice i oczekiwania", "Όρια και προσδοκίες", "Границы и ожидания")),
  section("family-change", t("Konflikt und Veränderung", "Conflict and change", "Conflicto y cambio", "Çatışma ve değişim", "Konflikt i zmiana", "Σύγκρουση και αλλαγή", "Конфликт и изменения")),
] as const;
const familySeeds: readonly DimensionSeed[] = [
  ["family-connection", "family-contact", t("Kontakt", "Contact", "Contacto", "İletişim", "Kontakt", "Επαφή", "Контакт"), "cadence"],
  ["family-connection", "family-closeness", t("Nähe und Eigenraum", "Closeness and space", "Cercanía y espacio propio", "Yakınlık ve kişisel alan", "Bliskość i własna przestrzeń", "Εγγύτητα και προσωπικός χώρος", "Близость и личное пространство"), "closeness", true],
  ["family-support", "family-care", t("Art der Fürsorge", "Style of care", "Forma de cuidado", "Özen biçimi", "Sposób troski", "Τρόπος φροντίδας", "Способ заботы"), "support", true],
  ["family-support", "family-responsibility", t("Verantwortung", "Responsibility", "Responsabilidad", "Sorumluluk", "Odpowiedzialność", "Ευθύνη", "Ответственность"), "ownership", true],
  ["family-support", "family-reliability", t("Verlässlichkeit", "Reliability", "Fiabilidad", "Güvenilirlik", "Niezawodność", "Αξιοπιστία", "Надёжность"), "structure"],
  ["family-boundaries", "family-boundaries", t("Persönliche Grenzen", "Personal boundaries", "Límites personales", "Kişisel sınırlar", "Granice osobiste", "Προσωπικά όρια", "Личные границы"), "structure"],
  ["family-boundaries", "family-expectations", t("Unausgesprochene Erwartungen", "Unspoken expectations", "Expectativas no dichas", "Söylenmeyen beklentiler", "Niewypowiedziane oczekiwania", "Άρρητες προσδοκίες", "Невысказанные ожидания"), "structure"],
  ["family-change", "family-conflict", t("Konflikte klären", "Repair after conflict", "Reparar tras un conflicto", "Çatışma sonrası onarım", "Naprawa po konflikcie", "Αποκατάσταση μετά τη σύγκρουση", "Восстановление после конфликта"), "pace"],
  ["family-change", "family-traditions", t("Traditionen und Werte", "Traditions and values", "Tradiciones y valores", "Gelenekler ve değerler", "Tradycje i wartości", "Παραδόσεις και αξίες", "Традиции и ценности"), "change"],
  ["family-change", "family-adaptation", t("Veränderungen gemeinsam tragen", "Navigating change", "Afrontar el cambio", "Değişimi birlikte yürütmek", "Przechodzenie przez zmianę", "Διαχείριση αλλαγής", "Совместное прохождение перемен"), "change", true],
];

const teamSections = [
  section("team-communication", t("Kommunikation und Feedback", "Communication and feedback", "Comunicación y feedback", "İletişim ve geri bildirim", "Komunikacja i informacja zwrotna", "Επικοινωνία και ανατροφοδότηση", "Общение и обратная связь")),
  section("team-coordination", t("Entscheidungen und Verantwortung", "Decisions and ownership", "Decisiones y responsabilidad", "Kararlar ve sorumluluk", "Decyzje i odpowiedzialność", "Αποφάσεις και ευθύνη", "Решения и ответственность")),
  section("team-craft", t("Tempo und Qualität", "Pace and quality", "Ritmo y calidad", "Tempo ve kalite", "Tempo i jakość", "Ρυθμός και ποιότητα", "Темп и качество")),
  section("team-resilience", t("Zusammenarbeit unter Druck", "Working under pressure", "Trabajo bajo presión", "Baskı altında çalışma", "Praca pod presją", "Συνεργασία υπό πίεση", "Работа под давлением")),
] as const;
const teamSeeds: readonly DimensionSeed[] = [
  ["team-communication", "team-communication", t("Informationsfluss", "Information flow", "Flujo de información", "Bilgi akışı", "Przepływ informacji", "Ροή πληροφοριών", "Обмен информацией"), "structure"],
  ["team-communication", "team-feedback", t("Feedback", "Feedback", "Feedback", "Geri bildirim", "Informacja zwrotna", "Ανατροφοδότηση", "Обратная связь"), "pace"],
  ["team-coordination", "team-decisions", t("Entscheidungen", "Decision-making", "Toma de decisiones", "Karar alma", "Podejmowanie decyzji", "Λήψη αποφάσεων", "Принятие решений"), "power"],
  ["team-coordination", "team-ownership", t("Verantwortung", "Ownership", "Responsabilidad", "Sahiplik", "Odpowiedzialność", "Ανάληψη ευθύνης", "Ответственность"), "ownership", true],
  ["team-coordination", "team-autonomy", t("Autonomie und Abstimmung", "Autonomy and coordination", "Autonomía y coordinación", "Özerklik ve koordinasyon", "Autonomia i koordynacja", "Αυτονομία και συντονισμός", "Автономия и координация"), "ownership", true],
  ["team-craft", "team-pace", t("Arbeitstempo", "Working pace", "Ritmo de trabajo", "Çalışma temposu", "Tempo pracy", "Ρυθμός εργασίας", "Темп работы"), "pace"],
  ["team-craft", "team-quality", t("Qualitätsanspruch", "Quality bar", "Nivel de calidad", "Kalite standardı", "Poziom jakości", "Πρότυπο ποιότητας", "Уровень качества"), "quality"],
  ["team-resilience", "team-collaboration", t("Zusammenarbeit", "Collaboration", "Colaboración", "İş birliği", "Współpraca", "Συνεργασία", "Сотрудничество"), "closeness", true],
  ["team-resilience", "team-conflict", t("Konfliktklärung", "Conflict repair", "Resolución de conflictos", "Çatışma çözümü", "Rozwiązywanie konfliktów", "Επίλυση συγκρούσεων", "Разрешение конфликтов"), "pace"],
  ["team-resilience", "team-reliability", t("Verlässlichkeit unter Druck", "Reliability under pressure", "Fiabilidad bajo presión", "Baskı altında güvenilirlik", "Niezawodność pod presją", "Αξιοπιστία υπό πίεση", "Надёжность под давлением"), "structure"],
];
...
const familyParts = buildParts(familySeeds, familySections);
const teamParts = buildParts(teamSeeds, teamSections);
...
export const relationshipModules: Readonly<Record<RelationshipModuleId, RelationshipModuleDefinition>> = {
  ...
  family: { id: "family", version: "family-v1", questionSetVersion: "family-questions-v1", interpretationVersion: "relationship-engine-v1.1", title: t("Family Alignment", "Family Alignment", "Alineación familiar", "Aile Uyumu", "Family Alignment", "Οικογενειακή ευθυγράμμιση", "Согласование в семье"), shortDescription: t("Nähe, Fürsorge, Verantwortung und Grenzen zwischen zwei Familienmitgliedern verstehen – ohne Familienform oder Hierarchie vorauszusetzen.", "Understand closeness, care, responsibility and boundaries between two family members without assuming a family structure or hierarchy.", "Comprender cercanía, cuidado, responsabilidad y límites entre dos familiares sin presuponer una estructura o jerarquía.", "Aile yapısı veya hiyerarşi varsaymadan iki aile üyesi arasındaki yakınlık, özen, sorumluluk ve sınırları anlamak.", "Zrozumieć bliskość, troskę, odpowiedzialność i granice między dwiema osobami z rodziny, bez zakładania struktury ani hierarchii.", "Κατανόηση εγγύτητας, φροντίδας, ευθύνης και ορίων μεταξύ δύο μελών οικογένειας χωρίς υπόθεση δομής ή ιεραρχίας.", "Понять близость, заботу, ответственность и границы между двумя членами семьи без предположений о структуре или иерархии."), sections: familySections, ...familyParts },
  team: { id: "team", version: "team-v1", questionSetVersion: "team-questions-v1", interpretationVersion: "relationship-engine-v1.1", title: t("Team Alignment", "Team Alignment", "Alineación de equipo", "Takım Uyumu", "Team Alignment", "Ευθυγράμμιση ομάδας", "Согласование в команде"), shortDescription: t("Arbeitsweisen zwischen zwei Teammitgliedern klären – ohne Leistungsscore, Überwachung oder Persönlichkeitsranking.", "Clarify working preferences between two teammates without performance scoring, surveillance or personality ranking.", "Aclarar preferencias de trabajo entre dos compañeros sin evaluar rendimiento, vigilar ni clasificar personalidades.", "Performans puanı, gözetim veya kişilik sıralaması olmadan iki ekip arkadaşının çalışma tercihlerini netleştirmek.", "Wyjaśnić preferencje pracy między dwiema osobami w zespole bez oceny wyników, nadzoru ani rankingu osobowości.", "Διευκρίνιση τρόπων εργασίας μεταξύ δύο μελών ομάδας χωρίς βαθμολόγηση απόδοσης, επιτήρηση ή κατάταξη προσωπικότητας.", "Прояснить рабочие предпочтения двух коллег без оценки эффективности, наблюдения или рейтинга личности."), sections: teamSections, ...teamParts },
