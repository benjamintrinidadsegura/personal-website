...
const pageItems: DiscoveryItem[] = [
  ...
  { id: "page-brain-manual", group: "Pages", title: "How my brain works + Quirks, Patterns, Abilities", description: "Benjamin's long-form personal operating manual: 33 connected thinking, building and human-context patterns, including their strengths and trade-offs.", category: "About / Long-form", tags: ["Brain Manual", "Patterns", "Aegis", "Personal operating manual"], keywords: ["How Benjamin thinks", "Quirks", "Systems Thinking", "Quick Context Switching"], status: "Live", href: "/about/how-my-brain-works" },
